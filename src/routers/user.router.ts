...
import { allUserListController, createUserController, softDeleteUserController, updadeUserController } from "../controllers/user.controller";
...
userRoutes.delete('/:id', verifyTokenIsValidMiddleware, verifyIfIdUserExistsMiddleware, verifyIsAdminUserMiddleware,   softDeleteUserController ) //users/:id	Realiza um soft delete no usuário
