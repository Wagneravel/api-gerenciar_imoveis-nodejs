...
export class createMigration1678754062067 implements MigrationInterface {
    name = 'createMigration1678754062067'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "real_estates" ("id" SERIAL NOT NULL, "value" numeric(11,2) NOT NULL, "size" integer NOT NULL, "sold" boolean NOT NULL DEFAULT false, "createdAt" date NOT NULL DEFAULT now(), "updatedAt" date NOT NULL DEFAULT now(), "categoryId" integer, "addressId" integer, CONSTRAINT "REL_f99f73de9b7e08033615e8b77c" UNIQUE ("addressId"), CONSTRAINT "PK_7213408ef49a1b9507bbadd065c" PRIMARY KEY ("id"))`);
